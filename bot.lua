...
BASE = '/home/api/Api/'
----------------------------------------------------------------------------
realm_id = -1001241332206 --Realm ID
----------------------------------------------------------------------------
SUDO = 492117565 --Sudo ID
----------------------------------------------------------------------------
sudo_users = {492117565,166674282} --Sudo ID
----------------------------------------------------------------------------
BOTS = 516445291 --Bot ID
----------------------------------------------------------------------------
bot_id = 516445291 --Bot ID
----------------------------------------------------------------------------
...
----------------------------------------------------------------------------
function is_bot(msg)
if tonumber(BOTS) == 516445291 then
return true
else
return false
end
...
local channel = '@WizzlyCh'
local url , res = https.request('https://api.telegram.org/bot516445291:AAEvX-8OsiFudvi6Ezz5VaCtqdXsPzgPP18/getchatmember?chat_id='..channel..'&user_id='..msg.sender_user_id_)
...
elseif value == 'join' or value == 'ورودی' then
if database:get('lang:gp:'..msg.chat_id_) then
text = 'join'
else
text = 'ورودی'
